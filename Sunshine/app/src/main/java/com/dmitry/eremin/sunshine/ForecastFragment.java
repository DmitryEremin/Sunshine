...
/**
 * Created by mitya_000 on 11.04.2016.
 */
public class ForecastFragment extends Fragment {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            //got from https://gist.github.com/udacityandroid/d6a7bb21904046a91695
            ...
            try {
                ...
                final String APPID_VALUE = "5301299b60f852e60ab6af562ffd08d8";
                ...
                Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                        ...
                        .build();
//"http://api.openweathermap.org/data/2.5/forecast/daily?id=1496153&mode=json&units=metric&cnt=7&APPID=5301299b60f852e60ab6af562ffd08d8"
